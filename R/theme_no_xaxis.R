#' A theme for vertical ggplot2 plots
#'
#' Same with theme_cowplot except without x-axis or x-ticks
#'
...
#' @export
theme_no_xaxis = function(font_size = 14, font_family = "", line_size = .5,
